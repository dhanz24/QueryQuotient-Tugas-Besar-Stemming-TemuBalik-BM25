...
class ProjectBesar(QMainWindow):
    def __init__(self):
        ...
        loadUi('D:\\Project\\QueryQuotient-Tugas-Besar-Stemming-TemuBalik\\gui1.ui', self)
        ...
        self.query_text = ""
        self.documents_directory = 'D:\\Project\\QueryQuotient-Tugas-Besar-Stemming-TemuBalik\\Files'
        self.files = []
        self.documents = []
    ...
    def perform_search(self):
        if self.selected_file_index != -1:
            ...
            # Menambahkan nilai doc_length, avg_doc_length, idf, dan tf ke textBrowser_2
            similarity_text += f"Doc Length: {self.doc_length}\n"
